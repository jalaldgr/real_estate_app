...
public class PreSaleModel {
    ...
    public PreSaleModel(String id, String title, String land_state_id, String created_at, String land_situation_id, String view, String landStateTitle, String landSituationTitle, String landSituationColor, String first_name, String last_name) {
        this.id = id;
        Title = title;
