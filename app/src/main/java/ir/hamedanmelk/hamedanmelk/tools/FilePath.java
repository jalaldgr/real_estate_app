        ...
        if (isKitKat && DocumentsContract.isDocumentUri(context, uri)) {
            ...
            if (isExternalStorageDocument(uri)) {
                ...
                if ("primary".equalsIgnoreCase(type)) {
                    Log.d(TAG, "getPath: context"+ Objects.requireNonNull(context.getExternalFilesDir(null)).getAbsolutePath());
            ...
            // MediaProvider
                ...
                return getDataColumn(context, Objects.requireNonNull(contentUri), selection,
                        selectionArgs);
            }
        }
